...
const String sheet_url = "https://script.google.com/macros/s/AKfycby8WOtqMEeYBSboIia3UJkjXcICQOrwWiPf9c4OEr-xPKHCObG-JbaW4o4o8dv-OcwWDw/exec?name=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "Syntaxium"  //Enter WiFi Name
#define WIFI_PASSWORD "Syntaxium@007"  //Enter WiFi Password
//-----------------------------------------
